...
export default function VideoLectureUnit7({ onBack }) {
  ...
  return (
    <div className="vl7-overlay" style={{
      ...
      <button
        ...
        style={{
          ...
          background: 'rgba(255,255,255,0.15)', color: '#f5e8c8',
      ...
      <div className="app-container">
        ...
        <main className="centre-column">
          <div className="centre-header">
            அலகு 1 : பாடம் 10 : ஐங்குறுநூறு 431
          </div>
